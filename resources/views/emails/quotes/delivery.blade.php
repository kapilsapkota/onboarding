            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="padding-bottom:0;">
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                               style="background-color:#ffffff;border:1px solid #e5e7eb; border-bottom:none;border-radius:12px 12px 0 0;">
                            <tr>
                                <td style="padding:28px 32px 24px 32px;">
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                        <tr> {{-- Company identity --}}
                                            <td style="vertical-align:middle;"> {{-- Replace with your real logo if available --}} @if(!empty($companyLogo))
                                                    <img src="{{ asset('images/All-in-IT-Solutions-Logo-SVG.svg') }}"
                                                         alt="{{ config('app.name') ?? 'All in IT Solutions' }}"
                                                         style="display:block;max-width:150px;max-height:55px;">
                                                @else
                                                    <p style="margin:0;font-size:22px;font-weight:700; color:#111827;letter-spacing:-0.5px;">
                                                        {{ config('app.name') ?? 'All in IT Solutions' }}
                                                    </p>
                                                @endif <p
                                                    style="margin:5px 0 0;font-size:13px;color:#6b7280;"> {{ $companyTagline ?? 'Professional IT & Technology Solutions' }} </p> {{-- Company contact details --}}
                                                <p style="margin:8px 0 0;font-size:11px;color:#9ca3af;line-height:1.5;"> {{ $companyWebsite ?? 'www.allinit.com.au' }}
                                                    @if(!empty($companyPhone))
                                                        &nbsp;&nbsp;•&nbsp;&nbsp; {{ $companyPhone }}
                                                    @endif
                                                </p>
                                            </td> {{-- Quotation information --}}
                                            <td align="right" style="vertical-align:middle;width:150px;"><p
                                                    style="margin:0 0 5px;font-size:11px;font-weight:600; color:#9ca3af;text-transform:uppercase; letter-spacing:1px;">
                                                    Quotation </p>
                                                <p style="margin:0;font-size:16px;font-weight:700; color:#111827;"> {{ $quoteNumber }} </p> @if(!empty($quoteDate))
                                                    <p style="margin:5px 0 0;font-size:11px;color:#6b7280;"> {{ $quoteDate->format('d M Y') }} </p>
                                                @endif </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="padding:0;">
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="height:4px;background-color:#2563eb; font-size:0;line-height:0;">
                                                &nbsp;
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="email-body" style="padding:36px 32px;">
                                    ...
                                    <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.7;">
                                        ...
                                        Please find your quotation <strong
                                            style="color:#111827;">{{ $quoteNumber }}</strong>
